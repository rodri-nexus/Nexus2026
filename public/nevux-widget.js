...
/* ═══════════════════════════════════════════
  ...
  function injectAtmosphericStyles() {
    try {
      ...
      console.warn("[Nevux] Error inyectando estilos atmosféricos:", e);
    }
  }
  ...
  function renderAtmosphericEffects(campaign) {
    try {
      ...
      // 🛡️ CAPA DE PROTECCIÓN: Si el body no existe aún, esperar a que esté listo
      if (!document.body) {
        document.addEventListener("DOMContentLoaded", function () {
          renderAtmosphericEffects(campaign);
        });
        return;
      }
      ...
      // 🛡️ Si algo llegara a fallar, el try-catch absorbe el error y previene que se rompan los widgets de la tienda
      console.error("[Nevux] Error controlado en efectos atmosféricos:", err);
    }
  }
  ...
  function renderHalloweenAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando atmósfera Halloween:", e);
    }
  }
  ...
  function renderSnowAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando nieve:", e);
    }
  }
  ...
  function renderFireEmbersAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando brasas:", e);
    }
  }
  ...
  function renderNeonSparklesAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando neon sparkles:", e);
    }
  }
  ...
  function renderHeartsAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando corazones:", e);
    }
  }
  ...
  function renderConfettiAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando confeti:", e);
    }
  }
  ...
  function renderBalloonsAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando globos:", e);
    }
  }
  ...
  function renderSaleTagsAtmosphere(container) {
    try {
      ...
      console.error("[Nevux] Error dibujando etiquetas de liquidación:", e);
    }
          }
})();
