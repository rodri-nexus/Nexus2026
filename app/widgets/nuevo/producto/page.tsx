...
function SeleccionarProductoContent() {
  ...
  // Selección de producto con transferencia de tipo de widget
  const handleSelectProduct = useCallback(
    (productId: number) => {
      if (selectedType) {
        router.push(
          `/widgets/nuevo/producto/${productId}?type=${encodeURIComponent(selectedType)}`
        );
      } else {
    ...
    <div style={{ maxWidth: "560px", margin: "0 auto", boxSizing: "border-box" }}>
      ...
      {loading ? (
        ...
        >
          ...
          <p style={{ fontSize: "0.95rem", fontWeight: 700, margin: "0 0 0.5rem 0" }}>
            Sin tienda conectada
          </p>
          <p style={{ fontSize: "0.85rem", opacity: 0.6, margin: 0 }}>
            Vinculá tu Tiendanube para importar tus productos.
          </p>
        </div>
      ) : products.length === 0 ? (
        <div
        ...
        >
          ...
          <p style={{ fontSize: "0.85rem", opacity: 0.6, margin: 0 }}>
            Cargá productos visibles en tu Tiendanube.
          </p>
        </div>
        ...
        >
          <Package
            size={40}
            color="#000000"
            style={{ margin: "0 auto 1rem auto", opacity: 0.3 }}
          />
          <p style={{ fontSize: "0.95rem", fontWeight: 700, margin: "0 0 0.5rem 0" }}>
            Sin coincidencias
          </p>
